...
client: client.cpp Histogram.o TCPRequestChannel.o common.o
	g++ -g -w -std=c++11 -fsanitize=address -fno-omit-frame-pointer -o client client.cpp Histogram.o TCPRequestChannel.o common.o -lpthread -lrt

server: server.cpp  TCPRequestChannel.o common.o
	g++ -g -w -std=c++11 -fsanitize=address -fno-omit-frame-pointer -o server server.cpp TCPRequestChannel.o common.o -lpthread -lrt
